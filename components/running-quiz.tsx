  ...
  return (
    <View className='flex-row gap-3 items-center'>
      ...
      <View className='flex-1'>
        <Text className='text-blue-primary font-semibold text-2xl'>
          CLIC DESAFIOS
        </Text>
        <View>
          <View className='flex-row gap-2 items-center'>
            ...
            <Text className='font-normal gap-2 flex-row text-gray-400'>
              <Text className='text-blue-primary'>8</Text>/10 Questões
            </Text>
          </View>
          <View className='flex-row gap-2 items-center'>
            <FontAwesome6  name="clock" size={12} color="grey" /> 
            <Text className='text-gray-400 gap-2 font-normal'>
              <Text className='text-blue-primary'>10</Text> min
            </Text>
          </View>
        </View>
      </View>
